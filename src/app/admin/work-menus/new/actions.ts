...
import { createWorkMenu } from "@/lib/services/work-menus";
...
export async function createWorkMenuAction(formData: FormData): Promise<void> {
  ...
  redirect(`/admin/work-menus/${menu.id}`);
}
